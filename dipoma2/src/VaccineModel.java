public class VaccineModel {
    ...
    private double calculateNextS(double s, double i, double betta, double totalPopulation, double vParam){
    ...
    private double calculateNextV(double s, double v, double vParam){
        return v + vParam*s;
    }
